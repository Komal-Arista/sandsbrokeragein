...
Tags: limit, content, revision, revisions
...
This plugin adds a new setting in the last position of Settings > General, this option will allow you to select limit of revisions that WordPress stores in the database.
...
1. Download and upload the plugin files to the /wp-content/plugins/limit-revisions directory from the WordPress plugin repository.
...
2. In the Search box enter “Limit Revisions” and hit Enter.
